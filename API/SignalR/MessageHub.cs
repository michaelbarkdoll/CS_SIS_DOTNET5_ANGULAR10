...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            // The following allows us to determine what other user the current user has clicked upon
            var otherUser = httpContext.Request.Query["user"].ToString();   // Key of "user" store query's user via.ToString in the key as otherUser
        ...
        public override async Task OnDisconnectedAsync(Exception exception)
        {
            ...
            // SignalR will automatically remove a user from a group when they disconnect automatically
        ...
        {
            // var connection = await this.unitOfWork.MessageRepository.GetConnection(Context.ConnectionId);
